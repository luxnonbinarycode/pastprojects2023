...
public class Tracker2 implements NumTrackerInterface{
    ...
    public void add(int numCount) {
        tracker2NumCount = numCount;
        System.out.println("Please type in your numbers > ");
        for (i = 0; i < tracker2NumCount; i++) {
            numSum += scnr.nextInt();
        }
    }
    ...
    public void findAverage() {
        ...
        double doubleTracker1NumCount = Double.valueOf(tracker2NumCount);
